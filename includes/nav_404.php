...
?>
<nav class="navbar navbar-expand-lg navbar-light navbar-main navbar-main-404">
    <div class="container-custom">
    <a class="navbar-brand" href="index.php">
        <img src="images/logo.png" class="navbar-main-logo" alt="Hibernia Nursery logo" id="navbarMainLogo"> 
    </a>
