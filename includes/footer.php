...
<footer class="pb-4">
    <div class="container-custom">
        <div class="row align-items-lg-center">
            ...
            <div class="col-md-6 col-lg-3 offset-lg-2 h-100">
                <h3 class="footer-bold text-uppercase">Links</h3>
                <ul>
                    <li><a href="index.php">Home</a></li>
                    <li><a href="availability.php">Availability</a></li>
                    <li><a href="locations.php">Other Locations</a></li>
                    <li><a href="contact.php">Contact</a></li>
                </ul>
            </div>
            <div class="col-md-6 col-lg-3 h-100">
                <h3 class="footer-bold text-uppercase">Contact</h3>
                <div class="footer-row mb-2">
                    <i class="las la-envelope mr-3 footer-icon"></i>
                    <span><a href="tel:mailto:Mike@hibernianursery.com">Mike@hibernianursery.com</a></span>
                </div>
                <div class="footer-row mb-2">
                    <i class="la la-phone mr-3 footer-icon"></i>
                    <span><a href="tel:3527934423">352-793-4423</a></span>
                </div>
