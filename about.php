...
<body>
    ...
    <div class="page-header pb-5" style="background-image: url('images/backgrounds/about.jpg');">
        ...
        <div class="container-custom py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 order-2 order-lg-1">
                    <h1 class="display-4">Hibernia Nursery</h1>
                ...
                <div class="col-lg-4 order-1 order-lg-2 mb-4 mb-lg-0">
                    <img src="images/sections/saplings.jpg" class="rounded-sm shadow img-fluid " alt="Young plants">
                </div>
            </div>
        </div>
